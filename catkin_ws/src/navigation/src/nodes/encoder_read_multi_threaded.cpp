...
// Include the navigation message types
...
void timerCallback(const ros::TimerEvent&)
{
    ...
    msg.left  = counts_for_m1a_local_copy  + counts_for_m1b_local_copy;
	msg.right = counts_for_m2a_local_copy + counts_for_m2b_local_copy;
...
int main(int argc, char* argv[])
{
    ...
    // std::thread reading_thread (timerCallback);
